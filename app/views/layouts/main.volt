...
?>
  ...
  <head>
    ...
    <meta name="description" content="FiSkinAlcon Minecraft皮肤站">
    <meta name="author" content="Lss233"> {{ get_title() }} {{ stylesheet_link('css/bootstrap.min.css') }} {{ stylesheet_link('css/metisMenu.min.css') }} {{ stylesheet_link('css/timeline.css') }} {{ stylesheet_link('css/sb-admin-2.css') }} {{ stylesheet_link('css/morris.css') }} {{ stylesheet_link('css/font-awesome.min.css')
    }} {{ stylesheet_link('css/nprogress.min.css') }} {{ javascript_include('js/nprogress.min.js') }}
    <script>
      NProgress.start();
    </script>
  </head>
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/FiSkinAlcon/index.php">FiSkinAlcon</a>
      </div>
      <!-- /.navbar-header -->
    ...
    {{ javascript_include('js/jquery.min.js') }} {{ javascript_include('js/bootstrap.min.js') }} {{ javascript_include('js/metisMenu.min.js') }} {{ javascript_include('js/raphael-min.js') }} {{ javascript_include('js/sb-admin-2.js') }} {{ javascript_include('js/msgs.js')
    }}
    </body>
